<head>
    ...
    <title><?php echo "$judul_halaman | $app_name"; ?></title>
    <meta name="theme-color" content="#A4DD00">
    <link rel="icon" type="image/svg+xml" href="assets/img/logo/<?php echo $app_icon; ?>?v=<?php echo $env_version; ?>">
    <link rel="apple-touch-icon" href="assets/img/logo/<?php echo $app_icon; ?>?v=<?php echo $env_version; ?>">
