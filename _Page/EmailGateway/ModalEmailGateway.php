        ...
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambah" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-plus"></i> Tambah Email Gateway</h5>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="email_gateway">
                                <small>Email Account <small title="Wajib Diisi">*</small></small>
                            </label>
                            <input type="email" class="form-control" name="email_gateway" id="email_gateway" placeholder="your-email@domain.com" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="password_gateway">
                                <small>Password Email <small title="Wajib Diisi">*</small></small>
                            </label>
                            <input type="password" class="form-control" name="password_gateway" id="password_gateway" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="url_provider">
                                <small>URL Provider <small title="Wajib Diisi">*</small></small>
                            </label>
                            <input type="text" class="form-control" name="url_provider" id="url_provider" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="port_gateway">
                                <small>Port <small title="Wajib Diisi">*</small></small>
                            </label>
                            <input type="text" class="form-control" name="port_gateway" id="port_gateway" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="nama_pengirim">
                                <small>Nama Pengirim <small title="Wajib Diisi">*</small></small>
                            </label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="url_service">
                                <small>URL Service (Base URL) <small title="Wajib Diisi">*</small></small>
                            </label>
                            <input type="url" class="form-control" name="url_service" id="url_service" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesKirimEmail">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-send"></i> Kirim Email</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col-md-12" id="FormKirimEmail">
                            <!-- Form Kirim Email Akan Muncul Disini -->
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-12" id="NotifikasiKirimEmail">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesEdit" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-pencil"></i> Edit Email Gateway</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesDelete" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-trash"></i> Hapus Email Gateway</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
