...
<div class="row mb-3">
    ...
    <div class="col-1"><small>:</small></div>
    <div class="col-7">
        <small class="text-grayish text-long" title="Password dimasked">
...
<div class="row mb-3">
    <div class="col-12">
        <div class="alert alert-danger text-center">
            <small>
                <b>PENTING!</b><br>
                Menghapus pengaturan <b>Email gateway</b> mungkin akan menyebabkan sistem tidak bisa mengirim email dalam konteks proses tertentu <br>
