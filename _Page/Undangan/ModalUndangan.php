                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <select name="OrderBy" id="OrderBy" class="form-control">
                                ...
                                <option value="datetime_invitation">Datetime</option>
                                <option value="method_invitation">Metode</option>
                                <option value="no_kontak">Phone/WA</option>
...
<div class="modal fade" id="ModalKirimUndangan" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-4 shadow-lg">
            <form action="javascript:void(0);" id="ProsesKirimUndangan">
                <div class="modal-header">
                ...
                <div class="modal-body p-4">
                    <div class="row">
                        <div class="col-12" id="FormKirimUndangan">
                            <!-- Form Tambah Responden -->
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-12" id="NotifikasiKirimUndangan">
                            <!-- Notifikasi Tambah Responden -->
                        </div>
                    </div>
                </div>
                <div class="modal-footer py-3">
                    <button type="submit" class="btn btn-primary btn-rounded fw-medium px-4 py-2" id="ButtonKirimUndangan">
                        <i class="bi bi-send me-2"></i> Kirim Undangan
                    </button>
