...
function ShowConnectionTable() {
    $.ajax({
        type    : 'POST',
        url     : '_Page/KoneksiSimrs/TabelKoneksiSimrs.php',
...
$(document).ready(function() {
    ...
    */
    ...
    $('#ProsesTambah').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/KoneksiSimrs/ProsesTambah.php',
            dataType: 'json',
            data    : ProsesTambah,
    ...
    $(document).on('click', '.modal_detail', function () {
        ...
        //tangkap data 'id_setting_simrs' dan buat variabel
        var id_setting_simrs   = $(this).data('id');
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/KoneksiSimrs/FormDetail.php',
            data        : {id_setting_simrs: id_setting_simrs},
            success     : function(data){
    ...
    $(document).on('click', '.modal_uji_koneksi', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/KoneksiSimrs/FormUjiKoneksi.php',
            data        : {id_setting_simrs: id_setting_simrs},
            success     : function(data){
    ...
    $(document).on('click', '.modal_edit', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/KoneksiSimrs/FormEdit.php',
            data        : {id_setting_simrs: id_setting_simrs},
            success     : function(data){
                $('#FormEdit').html(data);
            }
    ...
    $('#ProsesEdit').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/KoneksiSimrs/ProsesEdit.php',
            dataType: 'json',
            data    : ProsesEdit,
            success: function(response) {
                var status  = response.status;
    ...
    $(document).on('click', '.modal_delete', function () {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/KoneksiSimrs/FormDelete.php',
            data        : {id_setting_simrs: id_setting_simrs},
            success     : function(data){
    ...
    $('#ProsesDelete').submit(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/KoneksiSimrs/ProsesDelete.php',
            dataType: 'json',
            data    : ProsesDelete,
            success: function(response) {
                var status  = response.status;
